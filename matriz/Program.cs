...
namespace programa
{
    class FuncionesUtiles
    {
        static void Main(string[] args)
        {
            ...
            // moverse en diagonal en una matriz
            int menor = NumeroMenor(numeros.GetLength(0), numeros.GetLength(1));
            for(int i = 0; i < menor; i++)
            {
                numeros[i , i] = 99; 
            }
            *****/
             /*int [,] mat = LlenarMatriz(4, 4);
             ImprimirMatriz(mat);*/

            int[,] mat1 = LlenarMatrizA(4 ,4);
            ImprimirMatriz(mat1);
        ...
        static int[,] LlenarMatrizA(int filas, int columnas)
        {
            ...
            for (int f = filas - 1; f >=0 ; f--)
            {
                ...
                {
                    matriz[f, c] = contador; // Llenar la matriz con números del 1 al número de columnas
                    contador = contador + 1;
                }
            }
        ...
        static int mayor(int num1, int num2) // sacar el mayor de dos numeros
        {
         ...
         static int NumeroMenor(int num1, int num2) // sacar el menor de dos numeros
        {
            if (num1 < num2)
            {
                return num1;
